...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.bulkInsert('categoria', [
      ...
      { id: 4, nombre: 'Hogar y muebles', protegida: true, createdAt: new Date(), updatedAt: new Date() },
      { id: 5, nombre: 'Electrodomésticos', protegida: true, createdAt: new Date(), updatedAt: new Date() },
